...
export const PartnersListDataSource = {
  ...
  titleWrapper: {
    ...
    children: [
      ...
      { name: 'title', children: '金牌合作企业', className: 'title-h1' },
    ],
  },
  block: {
