...
class ProcessContact extends React.PureComponent {
        ...
        >
          ...
          <div {...childObj.textWrapper}>
            ...
            <TweenOne
              ...
              {...childObj.content}
            >
              {childObj.content.name === 'button' ? <Button type="link" href={childObj.content.children.href} target={childObj.content.children.target}>{childObj.content.children.children}</Button>: childObj.content.children}
            </TweenOne>
          </div>
        </TweenOne>
      );
